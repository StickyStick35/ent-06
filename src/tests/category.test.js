...
const BASE_URL_LOGIN = '/api/v1/users/login'//El nombre de la variables debe representar el contenido


beforeAll(async () => {
    const user = { //Se pasa el email y password que tengo en el usuario creado
